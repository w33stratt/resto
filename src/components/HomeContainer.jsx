...
const HomeContainer = () => {
    ...
    <p className='text-base text-textColor text-center md:text-left md:w-[80%]'>
        ...
        Sit nostrum assumenda quia doloremque voluptatum, 
        aperiam maiores magnam! Atque voluptatibus nisi consequatur 
        qui nihil similique cupiditate. Reprehenderit harum libero nostrum delectus?</p>
        <button 
        type='button' 
